...
public class Testing implements Runnable {
    private Queue<EmailData> emailDataQueue;
    public static void main(String[] args) {
        ExecutorService executor = Executors.newFixedThreadPool(2);//10threads & 10tasks = 17 emails in 10 minutes; 16threads & 1000tasks = 40emails; 500threads & 1000tasks = 155 emails;
        for (int i = 0; i < 2; i++) {      //1000 & 1000 = SLOW; 400 & 400 = 216; 300 and 300 = 202; 600 & 600 similar to 500;
    ...
    public Testing() {
        emailDataQueue = new LinkedList<>();
        emailDataQueue.add(new EmailData(new AtomicInteger(2), "a@gmail.com", "gmail.com", Timestamp.valueOf(LocalDateTime.now())));
        emailDataQueue.add(new EmailData(new AtomicInteger(2), "a@gmail.com", "gmail.com", Timestamp.valueOf(LocalDateTime.now())));
        emailDataQueue.add(new EmailData(new AtomicInteger(2), "a@gmail.com", "gmail.com", Timestamp.valueOf(LocalDateTime.now())));
        emailDataQueue.add(new EmailData(new AtomicInteger(2), "a@gmail.com", "gmail.com", Timestamp.valueOf(LocalDateTime.now())));
        emailDataQueue.add(new EmailData(new AtomicInteger(2), "a@gmail.com", "gmail.com", Timestamp.valueOf(LocalDateTime.now())));
